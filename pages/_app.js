  ...
  <div class="relative w-full max-w-lg shadow-2xl" style="height: fit-content;">
      ...
      <div class="relative  bg-gray-100 rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-center justify-between p-5 border-b rounded-t border-gray-300 dark:border-gray-600">
              ...
              <button type="button" id="closeModalButton" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="defaultModal">
          ...
          <div class="p-5 space-y-5">
            <p class="text-base leading-relaxed text-gray-600 dark:text-gray-400">
              ...
              <button id="readMoreButton" data-modal-hide="medium-modal" type="button" class="text-blue-500 background-transparent font-bold uppercase outline-none">Read More</button>
            </p>
            <p class="text-base leading-relaxed text-gray-600 dark:text-gray-400">
          ...
          <div class="flex justify-end items-center p-3 space-x-2 border-t border-gray-300 rounded-b dark:border-gray-600">
            ...
            <button id="disagreeButton" data-modal-hide="medium-modal" type="button" class="text-gray-600 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Decline</button>
          </div>
      </div>
  </div>
</div>
